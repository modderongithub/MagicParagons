...
namespace MagicParagons.Paragons.Towers
{
    public class ParagonSuperMonkey
    {
        public class SuperMonkeyParagon : ModVanillaParagon
        {
            public override string BaseTower => "SuperMonkey-520";
        }
        public class VengefulTerrorOfTheNight : ModParagonUpgrade<SuperMonkeyParagon>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                attackModel.weapons[0].projectile.ApplyDisplay<SuperMonkeyParagonDisplay_Projectile>();
                ...
                projectileModel.AddBehavior(new DamageModifierForTagModel("Moabs", "Moabs", 1.0f, 30000.0f, false, true));
                projectileModel.AddBehavior(new DamageModifierForTagModel("Boss", "Boss", 1.0f, 30000.0f, false, true));
                projectileModel.GetDamageModel().damage = 3000.0f;
        ...
        public class VengefulTerrorOfTheNightDisplay : ModTowerDisplay<SuperMonkeyParagon>
        {
            public override string BaseDisplay => GetDisplay(TowerType.SuperMonkey, 5, 0, 0);
